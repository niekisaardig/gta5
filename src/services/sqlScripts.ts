/**
 * Volledige Supabase SQL script voor Werkdonalds POS & WerkPay Bank.
 * Kan direct uitgevoerd worden in de Supabase SQL Editor (https://supabase.com/dashboard/project/_/sql).
 * Bevat alle tabellen, migraties, RPC functies, realtime rechten, demo-accounts en alle 138 Werkdonalds producten!
 */

export const UNIFIED_SUPABASE_SQL = `-- ==============================================================================
...
VALUES
  ...
  (138, 'Classic Heinz Ketchup', 0.80, 0.00, FALSE, 'Sauzen & WerkDips', '🥫', TRUE),
  (139, 'Belgische Mayonaise', 0.80, 0.00, FALSE, 'Sauzen & WerkDips', '🥫', TRUE),
  (140, 'Joppiesaus Echte Smaak', 0.85, 0.00, FALSE, 'Sauzen & WerkDips', '🥫', TRUE),
  (141, 'Red Bull Energy Drink (250ml)', 3.75, 0.00, FALSE, 'Koude Dranken & WerkShakes', '⚡', TRUE),
  (142, 'Red Bull Sugarfree (250ml)', 3.75, 0.00, FALSE, 'Koude Dranken & WerkShakes', '⚡', TRUE),
  (143, 'Monster Energy Original (500ml)', 3.95, 0.00, FALSE, 'Koude Dranken & WerkShakes', '⚡', TRUE),
  (144, 'Chaudfontaine Rood Bruiswater', 2.95, 0.00, FALSE, 'Koude Dranken & WerkShakes', '💧', TRUE),
  (145, 'Chaudfontaine Blauw Platwater', 2.95, 0.00, FALSE, 'Koude Dranken & WerkShakes', '💧', TRUE),
  (146, 'Biologische Appelsap Fles', 3.25, 0.00, FALSE, 'Koude Dranken & WerkShakes', '🍏', TRUE),
  (147, 'IJskoffie Karamel Macchiato', 3.95, 0.00, FALSE, 'Koude Dranken & WerkShakes', '🧋', TRUE),
  (148, 'IJskoffie Vanille Frappé', 3.95, 0.00, FALSE, 'Koude Dranken & WerkShakes', '🧋', TRUE),
  (149, 'Warme WerkKoffie Vers Gemalen', 2.65, 0.00, FALSE, 'Warme Dranken & Koffie', '☕', TRUE),
  (150, 'Cappuccino Romig Melkschuim', 3.25, 0.00, FALSE, 'Warme Dranken & Koffie', '☕', TRUE),
  (151, 'Latte Macchiato Lagen', 3.65, 0.00, FALSE, 'Warme Dranken & Koffie', '☕', TRUE),
  (152, 'Espresso Krachtig', 2.35, 0.00, FALSE, 'Warme Dranken & Koffie', '☕', TRUE),
  (153, 'Warme WerkChocomel met Slagroom', 3.45, 0.00, FALSE, 'Warme Dranken & Koffie', '🍫', TRUE),
  (154, 'Verse Muntthee met Honing', 3.25, 0.00, FALSE, 'Warme Dranken & Koffie', '🍵', TRUE),
  (155, 'Earl Grey Bloemige Thee', 2.65, 0.00, FALSE, 'Warme Dranken & Koffie', '🫖', TRUE)
